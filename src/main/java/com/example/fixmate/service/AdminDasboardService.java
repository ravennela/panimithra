...
public class AdminDasboardService {
        ...
        public AdminDashboardResponse getDashboardData() {
                ...
                long completedBookingsByPreviouMonth = bookingRepository.pendingBoookingsInMonth(
                                previousMonth.getMonthValue(),
                                previousMonth.getYear(), "COMPLETED");
                long pendingdBookingsByPreviouMonth = bookingRepository.pendingBoookingsInMonth(
                                previousMonth.getMonthValue(),
                                previousMonth.getYear(), "PENDING");
                long inprogressBookingsByPreviouMonth = bookingRepository.pendingBoookingsInMonth(
                                previousMonth.getMonthValue(),
                ...
                long totalBookinsInprogress = bookingRepository.countBookingsByStatus("INPROGRESS");
